package com.example.cloud_config_client2.service;
...
public class Excel2JSONHelper {
	...
	public static void main(String[] args) {
		File dir = new File("J:\\exceltojson.xls");
	...
	/**
	 * 文件过滤 @Title: fileNameFileter @Description:
	 * TODO(这里用一句话描述这个方法的作用) @param: @author LiYonghui @date 2017年1月6日
	 * 下午4:45:42 @return: void @throws
	 */
	...
	/**
	 * 获取表头行 @Title: getHeaderRow @Description:
	 * TODO(这里用一句话描述这个方法的作用) @param: @param sheet @param: @param
	 * index @param: @return @author LiYonghui @date 2017年1月6日
	 * 下午5:05:24 @return: Row @throws
	 */
	...
	/**
	 * 获取表格中单元格的value @Title: getCellValue @Description:
	 * TODO(这里用一句话描述这个方法的作用) @param: @param row @param: @param
	 * cellIndex @param: @param formula @param: @return @author LiYonghui @date
	 * 2017年1月6日 下午5:40:28 @return: Object @throws
	 */
	...
	/**
	 * 获取表头value @Title: getHeaderCellValue @Description:
	 * TODO(这里用一句话描述这个方法的作用) @param: @param headerRow @param: @param cellIndex
	 * 英文表头所在的行，从0开始计算哦 @param: @param type 表头的类型第一种
	 * 姓名（name）英文于实体类或者数据库中的变量一致 @param: @return @author LiYonghui @date
	 * 2017年1月6日 下午6:12:21 @return: String @throws
	 */
	...
	/**
	 * 读取excel表格 @Title: readExcle @Description:
	 * TODO(这里用一句话描述这个方法的作用) @param: @param file @param: @param
	 * headerIndex @param: @param headType 表头的类型第一种
	 * 姓名（name）英文于实体类或者数据库中的变量一致 @author LiYonghui @date 2017年1月6日
	 * 下午6:13:27 @return: void @throws
	 */
